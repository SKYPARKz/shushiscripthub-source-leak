--original script is fucking broken
--[[
	ui-engine-v2
	version 1.3a
...
do -- Example UI
	local Window = library:AddWindow("Clicker Madness!", {
		main_color = Color3.fromRGB(41, 74, 122),
	...
	do -- Elements	
		...
		local AutoFarm = Tab1:AddSwitch("AutoClick", function(bool)
		_G.on = bool
		while _G.on do
		wait()
		game:GetService("ReplicatedStorage").Aero.AeroRemoteServices.ClickService.Click:FireServer(11301301301)
		end
		end)
		AutoFarm:Set(false)
		
local ABCDEF = Tab1:AddSwitch("Kill All", function(bool)
		_G.on2 = bool
		while _G.on2 do
		wait()
...
local AutoKoth = Tab1:AddSwitch("Auto Koth",function(bool)
		_G.toggle = bool
		while _G.toggle do
                wait(0)
			...
			AutoKoth:Set(false)
local AutoCollect = Tab1:AddSwitch("TP Gems/Clicks",function(bool)
		_G.togglGGe = bool
		while _G.togglGGe do
                wait(0)
		...
		AutoCollect:Set(false)
Tab1:AddSwitch("Auto Normal Upgrades", function(bool)
            _G.toggled = bool
            while _G.toggled do
                wait(0)
		...
		local Pop = Tab1:AddSwitch("Pop Up",function(bool)
a = require(game:GetService("Players").LocalPlayer.PlayerScripts.Aero.Controllers.PopupEffectController)
a.Enabled = bool
end)
		Pop:Set(true)
local StatsDropDownValueR;
	local Sl = Tab1:AddDropdown("[Rebirth Select]",function(Re)
			StatsDropDownValueR = Re
    if value == "10" then
		Re = "1"
		...
		Re = "1000000000000"
			elseif value == "10q" then 
		Re = "10000000000000"
			elseif value == "100q" then 
		Re = "10000000000000"
		elseif Re == "1Q" then 
		Re = "1000000000000000"
		elseif value == "10Q" then 
		Re = "10000000000000000"
		elseif value == "100Q" then 
		Re = "100000000000000000"
		elseif value == "1s" then 
		Re = "1000000000000000000"
		elseif value == "10s" then 
		Re = "10000000000000000000"
		elseif value == "100s" then 
		Re = "100000000000000000000"
	...
	Sl:Add("10s")
	Sl:Add("100s")
				local Switch22 = Tab1:AddSwitch("Auto Rebirth", function(bool)
				
			_G.on20000000000 = bool
			while _G.on20000000000 do
				wait()
				game:GetService("ReplicatedStorage").Aero.AeroRemoteServices.RebirthService.BuyRebirths:FireServer(StatsDropDownValueR)
			end
		end)
		Switch22:Set(false)
		
local StatsDropDownValueboss;
local Bosses = Tab1:AddDropdown("Boss", function(B)
    StatsDropDownValueboss = B
		end
		end)
		Bosses:Add("Karen Keyboard")
		
local AutoBoss = Tab1:AddSwitch("Auto kill boss", function(bool)
    _G.on25555 = bool
    while _G.on25555 do
        wait()
		...
		local object = Workspace.ScriptObjects:FindFirstChild("Humanoid")

if object then --if there's a instance called "Object" in workspace, this gets passedend
		plr.Character.HumanoidRootPart.CFrame = workspace.ScriptObjects.StatsDropDownValu.HumanoidRootPart.CFrame*CFrame.new(0, 0, 0)
		plr.Character.HumanoidRootPart.CFrame = CFrame.new(plr.Character.HumanoidRootPart.Position, workspace.ScriptObjects.[StatsDropDownValueboss].HumanoidRootPart.Position)
		game:GetService("ReplicatedStorage").Aero.AeroRemoteServices.CursorCannonService.FireBoss:FireServer(StatsDropDownValueboss)
    end
	end
end)
AutoBoss:Set(false)

local TabEgg = Window:AddTab("Egg")
--[[
basic
lava
desert
...
infinity
future
ซื้อ3ฟอง game:GetService("ReplicatedStorage").Aero.AeroRemoteServices.EggService.PurchaseTriple:FireServer("winter")
]]--
local StatsDropDownValue;
local ATE = TabEgg:AddDropdown("Egg", function(E)
    StatsDropDownValue = E
if value == "basic" then
...
elseif value == "deluxe" then
elseif value == "omega" then
end
end)
ATE:Add("basic")
ATE:Add("desert")
...
local Switch = TabEgg:AddSwitch("Auto Egg", function(bool)
    _G.on25555 = bool
    while _G.on25555 do
        wait()
        game:GetService("ReplicatedStorage").Aero.AeroRemoteServices.EggService.Purchase:FireServer(StatsDropDownValue)
    end
end)
Switch:Set(false)
local SwitchE = TabEgg:AddSwitch("Auto Triple Egg", function(bool)
    _G.on255515 = bool
    while _G.on255515 do
        wait()
        game:GetService("ReplicatedStorage").Aero.AeroRemoteServices.EggService.PurchaseTriple:FireServer(StatsDropDownValue)
    end
end)
SwitchE:Set(false)


local TapTp = Window:AddTab("Teleports")		
local B = TapTp:AddButton("Desert Island", function()
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
            CFrame.new(
            2204.55737,
            6.57587671,
...
local B = TapTp:AddButton("Winter Island", function()
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
            CFrame.new(
            -2284.03174,
            6.64231157,
...
local B = TapTp:AddButton("Lava Island", function()
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
            CFrame.new(
            -1778.85901,
            6.59178734,
...
local TabEnd = Window:AddTab("Credits")
		TabEnd:AddLabel("Creator Discord : ! X x ShuShi x X !#0059")
		TabEnd:AddLabel("Creator DiscordServer : https://discord.gg/dYcawME")
		TabEnd:AddButton("Copy Creator Discord Tag", function()
			setclipboard(("! X x ShuShi x X !#0059"))
		end)
		TabEnd:AddButton("Copy Creator DiscordServer Link", function()
