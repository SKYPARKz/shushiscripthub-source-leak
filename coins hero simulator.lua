...
local Tab = library:CreateWindow("Farm")
local Tabup = library:CreateWindow("Buy")
local Tabs = library:CreateWindow("Skill")

local ATC = Tab:AddToggle("Auto Coin", function(bool)
_G.ATC = bool
while _G.ATC do
wait()

local pet = game:GetService("Players").Farn2000.PetMulti
local center = game:GetService("ReplicatedStorage").CoinToPlayer:FireServer(1)
local rank = game:GetService("Players").Farn2000.Rank.Multi.value

local coinmultiplevalue = 0

local plus = pet.value
local plus2 = rank

coinmultiplevalue = plus + plus2
-- game:GetService("ReplicatedStorage").CoinToPlayer:FireServer(coinmultiplevalue)
-- game:GetService("ReplicatedStorage").CoinToPlayer:FireServer(1)
...
while _G.ATS do
wait()
game:GetService("ReplicatedStorage").Remotes.Sell:FireServer(1)
end
end)

local DelPU = Tab:AddButton("Del Popup", function()
game:GetService("Players").Farn2000.PlayerGui.CoinIndicator:Destroy()
end)



local DelDoor = Tab:AddButton("Del All Stage Door", function()
game:GetService("Workspace").Levels.Walls["2"]:Destroy()
game:GetService("Workspace").Levels.Walls["3"]:Destroy()
game:GetService("Workspace").Levels.Walls["4"]:Destroy()
game:GetService("Workspace").Levels.Walls["5"]:Destroy()
game:GetService("Workspace").Levels.Walls["6"]:Destroy()
game:GetService("Workspace").Levels.Walls["7"]:Destroy()
end)
local ATUp = Tabup:AddToggle("Auto Upgrade All Skills", function(bool)
_G.ATUp = bool
while _G.ATUp do
wait()
...
local ATBp = Tabup:AddToggle("Auto Buy Backpack", function(bool)
_G.ATBp = bool
while _G.ATBp do
wait()
...
Tabs:AddLabel("Cosmos Skill Don't Work")
local ATBp = Tabs:AddToggle("inf skill", function(bool)
_G.ATBp = bool
while _G.ATBp do
wait()
