...
do -- Example UI
	local Window = library:AddWindow("Lifting Simulator", {
		main_color = Color3.fromRGB(41, 74, 122),
	...
	do -- Elements
		local AutoFarm1 = Tab:AddSwitch("Auto Farm", function(bool)
		_G.on1 = bool
		while _G.on1 do
		wait()
		...
		local AutoFarm9 = Tab:AddSwitch("Auto Speed", function(bool)
		_G.on9 = bool
		while _G.on9 do
		wait()
		...
		AutoFarm9:Set(false)
		local AutoFarm10 = Tab:AddSwitch("Auto Durability", function(bool)
		_G.on10 = bool
		while _G.on10 do
		wait()
		...
		AutoFarm10:Set(false)
		local AutoFarm11 = Tab:AddSwitch("Auto Strength", function(bool)
		_G.on11 = bool
		while _G.on11 do
		wait()
		local A_1 = "Punching"
		local A_2 = Workspace.PowerTrainingFolder.Model
		local Event = game:GetService("ReplicatedStorage").Network.Port1
		Event:FireServer(A_1, A_2)
		end
		end)
		
		AutoFarm11:Set(false)
		
		local AutoFarm2 = Tab:AddSwitch("Auto Sell", function(bool)
		_G.on2 = bool
		while _G.on2 do
		wait()
		...
		local Switch1 = Tab:AddSwitch("Auto Buy Strength", function(bool)
		_G.on3 = bool
		while _G.on3 do
		wait()
		local A_1 = "Purchase"
		...
		local Switch2 = Tab:AddSwitch("Auto Buy Endurance", function(bool)
		_G.on4 = bool
		while _G.on4 do
		wait()
		local A_1 = "Purchase"
		...
		Switch2:Set(false)
		local Switch3 = Tab:AddSwitch("Auto Rebirths", function(bool)
		_G.on5 = bool
		while _G.on5 do
		wait()
		local A_1 = "Purchase"
		...
		local Folder = Tab:AddFolder("Credits") -- This can contain exactly the same as a Tab. You can have as many folders as you'd like to.
