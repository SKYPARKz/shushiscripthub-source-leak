...
do -- Example UI
	local Window = library:AddWindow("Legends Of Speed", {
		main_color = Color3.fromRGB(41, 74, 122),
	...
	do -- Elements
Tab:AddLabel("Work In City Island !!! City Only")
		local Switch = Tab:AddSwitch("YellowOrb", function(bool)
_G.on = bool
while _G.on do
wait()
...
Event:FireServer(A_1, A_2, A_3)
		...
		Switch:Set(false)
		local Switch2 = Tab:AddSwitch("Gem", function(bool)
_G.on = bool
while _G.on do
wait()
...
Event:FireServer(A_1, A_2, A_3)
		...
		Switch:Set(false)
		local Switch3 = Tab:AddSwitch("BlueOrb", function(bool)
_G.on = bool
while _G.on do
wait()
...
Event:FireServer(A_1, A_2, A_3)
		...
		Switch:Set(false)
		local Switch4 = Tab:AddSwitch("RedOrb", function(bool)
_G.on = bool
while _G.on do
wait()
...
Event:FireServer(A_1, A_2, A_3)
		...
		Switch:Set(false)
				local Switch5 = Tab:AddSwitch("AutoRebirth", function(bool)
_G.on = bool
while _G.on do
wait()
